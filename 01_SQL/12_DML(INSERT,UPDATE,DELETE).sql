/*
    ...
    DML(MANIPULATION 데이터 조작어) : INSERT, UPDATEM DELETE
...
VALUES(900, '김수민', '880914-1234567', 
        'SD123@naver.com', 01012345678, 'D7', 'J5', 4000000, 0.2, 200, SYSDATE, NULL, 'N');
...
--EMP_SALARY테이블에서 선동일 사원의 급여를 700만원, 보너스 0.2로 변경
UPDATE EMP_SALARY
SET SALARY = 7000000, 
    BONUS = 0.2
WHERE EMP_NAME = '선동일';
...
/*
    4. DELETE
    테이블에 기록되 데이터를 삭제하는 구문(한 행 단위로 삭제가 됨.)
