/*
    ...
    INSERT 시켜줘야한다.
    - 신고횟수가 일정 수를 넘었을 대 묵시적으로 해당 회원을 블랙리스트 목록에 추가해야할 때.
    
    트리거 특징
    - 사용자가 명시적으로 실행하지 않아도 자동 실행됨.
    - 데이터 무결성, 로깅, 자동처리등에 유용.
    - 테이블 단위로 작성되며, 트리거 대상을 테이블
...
INSERT INTO TB_PRODETAIL VALUES(SEQ_DCODE.NEXTVAL, 200, SYSDATE, 10, 'IN');
...
INSERT INTO TB_PRODETAIL VALUES(SEQ_DCODE.NEXTVAL, 205, SYSDATE, 20, 'IN');
...
--TB_PRODUCT테이블에 매번 자동을 재고수량을 UPDATE하는 트리거
...
INSERT INTO TB_PRODETAIL VALUES(SEQ_DCODE.NEXTVAL, 210, SYSDATE, 7, 'IN');

--205번 상품이 오늘날짜로 4개 출고
INSERT INTO TB_PRODETAIL VALUES(SEQ_DCODE.NEXTVAL, 205, SYSDATE, 4, 'OUT');
