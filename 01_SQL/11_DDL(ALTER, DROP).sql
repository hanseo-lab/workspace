/*
    ...
    <ALTER>
    객체를 변경하는 구문
    기존에 생성된 객체(테이블, 컬럼, 제약조건 등)의 구조를 변경(수정, 추가, 제거, 이름변경등)을 할 때 사용.
...
ALTER TABLE DEPARTMENT MODIFY CNAME VARCHAR(30);
...
--테이블 삭제
-- DROP TABLE 테이블명;
-- 어딘가에 참고되고있는 부모테이블은 함부로 삭제되지 않는다.
...
--3) 컬럼명/제약조건명/테이블명 변경
--3_1) 컬럼명 변경 : RENMME COLUMN 기존컬럼명 TO 새로운컬럼명
--DEPT_TILTE -> DEPT_NAME
ALTER TABLE DEPT_COPY RENAME COLUMN DEPT_TITLE TO DEPT_NAME;

--3_2)제약조건명 변경 : RENMME CONSTRAINT 기존제약조건명 TO 새로운제약조건명
