...
CREATE TABLE TB_PUBLISHER (
    ...
    PUB_NAME VARCHAR2(100) CONSTRAINT PUBLISHER NOT NULL,
    PHONE    VARCHAR2(13)
);
...
-- 샘플 5개 정도 생성
INSERT INTO TB_BOOK
VALUES(100, 'SQL알아가기', '최지원', 30000, 1);

INSERT INTO TB_BOOK
VALUES(101, 'SQL알아가기2', '최지원', 31000, 1);

INSERT INTO TB_BOOK
VALUES(102, 'SQL알아가기3', '최지원', 32000, 1);

INSERT INTO TB_BOOK
VALUES(103, '이것이 자바다', '심원용', 32000, 2);

INSERT INTO TB_BOOK
VALUES(104, '이것이 자바다2', '심원용', 32000, 3);
...
VALUES(200, 'USER01', 'PASS01', '홍길동', 'M', '서울시 강남구', 
'010-1111-2222', 'N', '25/07/30' );

INSERT INTO TB_MEMBER
VALUES(201, 'USER02', 'PASS01', '홍길순', 'F', '서울시 강남구', 
'010-1111-2222', 'N', '25/07/30' );

INSERT INTO TB_MEMBER
VALUES(202, 'USER03', 'PASS01', '홍길삼', 'M', '서울시 강남구', 
'010-1111-2222', 'N', '25/07/30' );

INSERT INTO TB_MEMBER
VALUES(203, 'USER04', 'PASS01', '홍길사', 'F', '서울시 강남구', 
'010-1111-2222', 'N', '25/07/30' );

INSERT INTO TB_MEMBER
VALUES(204, 'USER05', 'PASS01', '홍길오', 'M', '서울시 강남구', 
'010-1111-2222', 'N', '25/07/30' );
...
CREATE TABLE TB_RENT(
    ...
    CONSTRAINT RENT_FK_MEN FOREIGN KEY(RENT_MEM_NO) REFERENCES TB_MEMBER ON DELETE SET NULL,
...
-- 샘플 3개 정도 생성
INSERT INTO TB_RENT
VALUES(300, 200, 100, '25/07/30' );

INSERT INTO TB_RENT
VALUES(301, 201, 101, '25/07/30' );

INSERT INTO TB_RENT
VALUES(302, 202, 102, '25/07/30' );
