...
public class Run {
	 ...
	 * 
	 * - 자료구조 : 데이터를 보다 효율적을 관리(추가, 삭제, 조회, 정렬, 수정)할 수 있도록 해주는 구조
	 */
	...
	public static void main(String[] args) {
		...
		//2.add(int indext, E e) : 직접 인덱스를 지정해서 해당위치에 데이터를 추가
		...
		//4.remove(E e) : 객체를 직접 지정해서 삭제(사용을 위해서 객체의 equals를 적절하게 오버라이딩 해줘야함)
		list.remove("이무진"); 
		list.remove(new Human("임재현", 27));
		System.out.println(list);
		
		//5.set(int index, E e) : 해당 인덱스이 값을 전달받은 e객체로 덮어씌움
