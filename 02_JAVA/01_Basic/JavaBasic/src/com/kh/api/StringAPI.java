...
public class StringAPI {
	public void method01() {
		...
		//String클래스는 toString메서드는 이미 오버라이딩 되어있음
		...
		//상수이기 때문에 새로운 값을 String pool에 만들고 참조하도록 되어있음.
	}
	...
	public void method02() {
		...
		System.out.println("str1에 ello라는 문자열이 포함 ? : " + str1.contains("ello") );
		System.out.println("str1에 bye라는 문자열이 포함 ? : " + str1.contains("bye") );
		
		//문자열.concat(String str) : String
		//문자열과 전달된 또다른 문자열 하나로 합쳐서 새로운 문자열을 리턴
		...
		//문자열에서 대상문자를 찾아서 변경할 문자로 대체한 후 변경된 문자열을 반환
	...
	public void method03() {
		...
		//구분자를 기준을 문자열을 분리시키는 방법
		//방법1. 분리된 문자열들을 String[]에 차곡차곡 담아야할 때
		//String에서 제공한 split메서드를 사용
		...
		System.out.println(stn.countTokens()); //토큰의 남은 개수
		...
		stn = new StringTokenizer(str, ",");
		while(stn.hasMoreElements()) { //남은 토큰이 있냐?
			System.out.println(stn.nextToken());
		}
	}
}
