...
public class DateAPI {
	public void method() {
		Date date1 = new Date(); //매개변수없는 생성자 호출시 코드 실행 시점의 컴퓨터 시간이 반영
		...
		System.out.println("시간부분 : " + date3.toLocalTime());
		
		//5. 포멧팅
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("ss초 yyyy년 MM월 dd일 HH시 mm분");
