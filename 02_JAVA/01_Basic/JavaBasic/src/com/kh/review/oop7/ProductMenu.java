...
public class ProductMenu {
	...
	public void insertProduct() {
		...
		boolean isInsert = pc.insertProduct(pName, price, brand);
		if (isInsert) {
	...
	/*
	 * 키워드를 입력받아 제품명을 통한 키워드 검색을 하여 제품 목록을 출력
	 */
	...
	/*
	 * 상품명과 수정할 가격을 입력받아 해당 상품의 가격을 수정한다.
	 */
	public void updateProduct() {
		System.out.print("수정할 상품영 : ");
		String pName = sc.nextLine();
		System.out.print("수정할 가격 : ");
		int newPrice = sc.nextInt();
		sc.nextLine();
		boolean isUpdate = pc.updateProduct(pName, newPrice);
		if(isUpdate) {
