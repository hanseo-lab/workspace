...
public class For {
	/*
	 * <반복문>
	 * 특정 코드를 여러 번 반복헤서 실행하고자 할 때 사용하는 제어문.
	 * 
	 ...
	 * }
	 * 
	 * 초기식 : 반복을 시작하기 전에 변수를 선언하고 초기값 설정, 처음 딱 한번만 실행됨.
	...
	public static void main(String[] args) {
		...
		*/
		...
		//System.out.println(num); --블록내에 선언한 변수를 외부에서 사용할 수 없음.
		
		/*
		 * 초기식, 조건식, 증감식을 꼭 입력해야 하는 것 아닌지만
		...
		*/
		 ...
		 * 
		 * Math.rando() 호출시 -> 0.0~0.999999999999사이의 랜덤값을 반환
		...
		System.out.println("1~" + n +"까지의 합 : " + sum1 );
